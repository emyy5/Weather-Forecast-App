...
import com.eman.weathetapplication.utils.units
...
class InitialFragment : Fragment() {
    ...
    val locationCallBack = object : LocationCallback(){
        override fun onLocationResult(myLocation: LocationResult?) {
            ...
            settings?.location = 1
            repo.addSettingsToSharedPreferences(settings as com.eman.weathetapplication.data.model.Settings)

            val action = InitialFragmentDirections.actionInitialFragmentToHomeFragment(loc.latitude.toFloat(),loc.longitude.toFloat(),
